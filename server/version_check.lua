...
Citizen.CreateThread( function()
    updatePath = "/LetsTiger/tg_blipmaker"
    resourceName = "Blipmaker Script ("..GetCurrentResourceName()..")"
...
function Resourcestart()
    print('^4.-------------------------------------------------------------------------------------------------------------------.')
    print('^4|^0                                             TG Blipmaker Script                                                   ^4|')
    print('^4|^0                                    <Made by Tiger (Discord: lets_tiger)>                                          ^4|')
    print('^4|-------------------------------------------------------------------------------------------------------------------|')

    if rio then
        print("^4|▶ ^0[^1ERROR^0] ^1"..resourceName.." ist veraltet! Bitte updaten: https://github.com/LetsTiger/tg_blipmaker/            ^4|")
